...
const opacity = useTransform(scrollYProgress, [0, 1], [.3,1]);
  ...
  return (
    <div className="bg-black text-white bg-gradient-to-b from-black to-lime-400 py-[72px] sm:py-24">
      <div className="container">
        <h2 className=" text-6xl font-medium text-center mt-6 max-w-2xl m-auto">Intituve  <span className="text-lime-400">interface</span></h2>
