  ...
  return (
    <section className="py-24">
      <div className="container">
        <div className="">
          <h2 className="text-lime-400 text-6xl font-medium text-center mt-6">Pricing</h2>
          <p className="text-2xl font-medium text-center mt-6  m-auto ">
          ...
          {pricingTiers.map(
            ({
              ...
              <div
                ...
                className={twMerge(
                  "card",
                  inverse === true && "border border-white/10 bg-neutral-900 text-white",
                )}
              >
